...
class MyStrategy(IStrategy):
    ...
    buy_rsi_min = DecimalParameter(20, 45, default=30, decimals=0, space="buy", optimize=True)
    buy_rsi_max = DecimalParameter(45, 70, default=62, decimals=0, space="buy", optimize=True)
